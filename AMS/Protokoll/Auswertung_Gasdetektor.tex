...
\begin{center}
  \begin{tabular}{|c|c|c|c|}
    ...
    \hline
    \multirow{4}*{$^{10}\text{Be}^{4+}$} & \SI{6.2}{\mega\electronvolt}  & \SI{0.046}{\mega\electronvolt\per\milli\metre} & \SI{134}{\milli\metre}  \\
    ...
    \hline
    \multirow{4}*{$^{10}\text{B}^{4+}$}  & \SI{5.8}{\mega\electronvolt}  & \SI{0.064}{\mega\electronvolt\per\milli\metre} & \SI{91}{\milli\metre}   \\
